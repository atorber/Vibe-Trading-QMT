...
- **2026-09-02** 📊 **Reserva de precios QMT Bridge / akshare para el bench CSI300 y doble curva bruta/neta en Portfolio**: si falta dj_factor de Tushare o el panel CSI300 es demasiado fino, el cargador recurre a **barras QMT Bridge ajustadas al contado** y luego **akshare**; rechaza cachés corruptas y muestra motivos de omisión en la UI. El historial de /portfolio traza **activo total** y **activo neto** juntos.
