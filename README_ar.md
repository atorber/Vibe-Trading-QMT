...
- **2026-09-02** 📊 **احتياطي أسعار QMT Bridge / akshare لمعيار CSI300، ومخطط إجمالي/صافي الأصول في المحفظة**: عند غياب dj_factor من Tushare أو رقة لوحة CSI300، يعود المحمّل إلى **أشرطة QMT Bridge المعدّلة أمامياً** ثم **akshare**؛ تُرفض اللوحات الرقيقة والذاكرة المؤقتة التالفة وتُعرض أسباب التخطي في الواجهة. يعرض سجل أصول /portfolio **إجمالي الأصول** و**صافي الأصول** معاً.
